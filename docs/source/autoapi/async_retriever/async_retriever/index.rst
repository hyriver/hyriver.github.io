...
.. py:function:: retrieve(urls, read_method, request_kwds = None, request_method = 'get', limit_per_host = 5, cache_name = None, timeout = 5, expire_after = EXPIRE_AFTER, ssl = True, disable = False, raise_status = True)
   ...
   :Parameters: * **urls** (:class:`list` of :class:`str`) -- List of URLs.
                ...
                * **limit_per_host** (:class:`int`, *optional*) -- Maximum number of simultaneous connections per host, defaults to 5.
...
.. py:function:: retrieve_binary(urls, request_kwds = None, request_method = 'get', limit_per_host = 5, cache_name = None, timeout = 5, expire_after = EXPIRE_AFTER, ssl = True, disable = False, raise_status = True)
...
.. py:function:: retrieve_json(urls, request_kwds = None, request_method = 'get', limit_per_host = 5, cache_name = None, timeout = 5, expire_after = EXPIRE_AFTER, ssl = True, disable = False, raise_status = True)
...
.. py:function:: retrieve_text(urls, request_kwds = None, request_method = 'get', limit_per_host = 5, cache_name = None, timeout = 5, expire_after = EXPIRE_AFTER, ssl = True, disable = False, raise_status = True)
